 ...
 *
 */
public class PPT_File___AXA__ extends pageObject.TestBase implements FactoryLocator , FileFactoryLocator{
	/**
	 * 
	 * @param method
 ...
 */
	       ...
	       public void DownloadAnnotation_XFDF_File_via_ppt(Method method) throws InterruptedException{ page.getInstance(DownloadAnnotationXFDF.class).Dodownloadxfdf();
	       Assert.assertTrue(true);
	       Thread.sleep(1000);
	        }
