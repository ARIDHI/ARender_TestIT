 ...
 *
 */
public class Tiff_File___AXA__  extends pageObject.TestBase implements ARender____FactoryPage, File____FactoryPage {
	/**
	 * 
	 * @param method
	 ...
	 */	 
	    ...
	    public void Tiff_File____Upload (Method method) throws InterruptedException, IOException {
			driver.get("http://18.203.215.159:8080/arondor-arender-axa-war-4.1.0-rc0/?bean=urlParserExternalAccessorProxy&id=%7B0B24C37A-5E27-C950-87D3-74FD88D00000%7D&objectStoreName=OS1&documentId=0B24C37A-5E27-C950-87D3-74FD88D00000");		
...
//	            }	
		 ...
		 /**
		   ...
		   */
		    ...
		    public void Handle_FreeText___On_tiff(Method method) throws InterruptedException { page.getInstance(freeTextAnnotationHandler.class).doDrowfreetext(); 	
		    // TODO Check notification message is not wrong
		 	// TODO Check annotation is displayed 
		    // TODO Check style barre is displayed
		    try {  
			...
			public void Handle_Circle___On_tiff(Method method) throws InterruptedException { page.getInstance(circleAnnotationHandler.class).doDrowcircle();	
			// TODO Check notification message is not wrong
		    // TODO Check annotation is displayed 
		    // TODO Check style barre is displayed
			try {
			...
			public void Handle_Arrow___On_tiff(Method method) throws InterruptedException { page.getInstance(arrowAnnotationHandler.class).doDrowArrow();
			// TODO Check notification message is not wrong
		    // TODO Check annotation is displayed 
		    // TODO Check style barre is displayed
			try {
			...
			public void Handle_Underline___On_tiff(Method method) throws InterruptedException {page.getInstance(UnderLineHandler.class).doDrowUnderline();
			// TODO Check notification message is not wrong
		    // TODO Check annotation is displayed 
		    // TODO Check style barre is displayed
			try {
			...
			public void Handle_freeHand___On_tiff(Method method) throws InterruptedException { page.getInstance(freeHandAnnotationtHandler.class).doDrowfreehand();
			// TODO Check notification message is not wrong
		    // TODO Check annotation is displayed 
		    // TODO Check style barre is displayed
			try {
			...
			public void Handle_polyline___On_tiff(Method method) throws InterruptedException { page.getInstance(polylineAnnotationHandler.class).doDrowpolyline();	
			// TODO Check notification message is not wrong
		    // TODO Check annotation is displayed 
		    // TODO Check style barre is displayed
			try {
			...
			public void Handel_Polygone___On_tiff(Method method) throws InterruptedException { page.getInstance(PolygoneannotationHandler.class).doDrowpolygone();
			// TODO Check notification message is not wrong
		    // TODO Check annotation is displayed 
		    // TODO Check style barre is displayed
			try {
			 ...
			 @Test (priority = 10 ,enabled= true)
				public void Urgent_Stamp___On_tiff() throws InterruptedException { 
				...
				public void Approved_Stamp___On_tiff() throws InterruptedException  { 
					page.getInstance(StumpAnnotaionHandler.class).doDrowStamp();
				...
				public void Draft_Stamp___On_tiff() throws InterruptedException  { 
					page.getInstance(StumpAnnotaionHandler.class).doDrowStamp();
				...
				public void Signature_Stamp___On_tiff() throws InterruptedException  { 
					page.getInstance(StumpAnnotaionHandler.class).doDrowStamp();
				...
				public void delete__Anotation___On_tiff(Method method) throws InterruptedException {
				...
				public void Simple_Hide_Annotation_fonction_On_tiff(Method method) throws InterruptedException {
			   ...
			   try {
				...
				public void Multiple_Hide_Annotation_fonction_On_tiff(Method method) throws InterruptedException {
					try {
						page.getInstance(hideAnnotationPage.class).showAnnotations();
	 ...
	 */
	       ...
	       public void Download_PDF_File_via_tiff (Method method) throws InterruptedException{
	        page.getInstance(DownloadPDF.class).DodownloadPdf();
	        Assert.assertTrue(true);
	        Thread.sleep(1000);
	        }	
	        @Test (priority = 18  ,timeOut = 10000)
	        public void DownloadAnnotation_FDF_File_via_tiff(Method method) throws InterruptedException{
		     page.getInstance(circleAnnotationHandler.class).doDrowcircle();
	       ...
	       public void DownloadAnnotation_XFDF_File_via_tiff(Method method) throws InterruptedException{ page.getInstance(DownloadAnnotation_XFDF.class).Dodownloadxfdf();
	       Assert.assertTrue(true);
	       Thread.sleep(1000);
	        }
	       @Test (priority = 20  ,timeOut = 10000)
	       public void Download_Document_withAnnotation_FDF_File_via_tiff(Method method) throws InterruptedException{ page.getInstance(DownloadDocumentwithAnnotationFDF.class).DodownloadwithAnnotationFdf();
	        Assert.assertTrue(true);
	       Thread.sleep(1000);
	       }
	       @Test (priority = 21 ,timeOut = 10000)
	       public void DownLoad_With_Annotation_CSV_File_via_tiff(Method method) throws InterruptedException{ page.getInstance(DownLoadWithAnnotationCSV.class).DodownloadWithAnnotationCSV();
	       Assert.assertTrue(true);
	       Thread.sleep(1000);
	       }

	       @Test(priority = 22 )
	       public void Upload__File_via_tiff(Method method) throws InterruptedException  {
