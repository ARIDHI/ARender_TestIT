 ...
 *
 */
public class Word_File___AXA__ extends pageObject.TestBase implements FactoryLocator , FileFactoryLocator {
	/**
	 * 
	 * @param method
...
//			Thread.sleep(500);	  	 
	 ...
	 */
	       ...
	       public void DownloadAnnotation_XFDF_File_via_word(Method method) throws InterruptedException{ page.getInstance(DownloadAnnotationXFDF.class).Dodownloadxfdf();
	       Assert.assertTrue(true);
	       Thread.sleep(1000);
	        }
