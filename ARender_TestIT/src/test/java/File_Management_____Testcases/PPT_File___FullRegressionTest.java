 ...
 *
 */
public class PPT_File___FullRegressionTest extends pageObject.TestBase implements ARender____FactoryPage , File____FactoryPage{
	/**
	 * @param method
...
//		              +page.getInstance(HanlerBasePage.class).isDisplayed(styleBarre));
...
//		}
	 ...
	 */	 
	   ...
	   */
		...
		public void Handle_StickyNote___On_PPT (Method method) throws InterruptedException{ page.getInstance(StickyNoteAnnotationHandler.class).doDrowSticky();
	    // TODO Check notification message is not wrong
