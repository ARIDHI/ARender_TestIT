 ...
 *
 */
public class Tiff_File___Full_RegressionTest  extends pageObject.TestBase implements ARender____FactoryPage, File____FactoryPage {
	/**
	 * 
	 * @param method
	 ...
	 */	 
		...
		try {
		    Assert.assertEquals(page.getInstance(HandlerBasePage.class).getNotificationMsg(notificationmsg),"Document courant : file_example_TIFF_10MB.tiff", "error accurred file can not uploaded");
		...
		@Test (priority = 2 , dependsOnMethods="Tiff_File____Upload")
		...
		@Test (priority = 3 , dependsOnMethods="Tiff_File____Upload")	
	    public void Handle_FreeText___On_Tiff(Method method) throws InterruptedException { 
    	 try {
		...
		@Test(priority = 4 , dependsOnMethods="Tiff_File____Upload")
		...
		@Test (priority = 5 , dependsOnMethods="Tiff_File____Upload")
		public void Handle_Arrow___On_Tiff(Method method) throws InterruptedException {
			try {
		...
		@Test (priority = 6  , dependsOnMethods="Tiff_File____Upload")
		public void Handle_Underline___On_Tiff(Method method) throws InterruptedException {
		  try {
		...
		@Test (priority = 7 , dependsOnMethods="Tiff_File____Upload")
		public void Handle_freeHand___On_Tiff(Method method) throws InterruptedException { 
		   try {
			 page.getInstance(freeTextAnnotationHandler.class).checkFreeTextTest();
		     }			
	       finally { 
		...
		@Test (priority = 8 , dependsOnMethods="Tiff_File____Upload")
		public void Handle_polyline___On_Tiff(Method method) throws InterruptedException { 
		try {
		...
		@Test (priority = 9 ,dependsOnMethods="Tiff_File____Upload")
		public void Handel_Polygone___On_Tiff(Method method) throws InterruptedException { 
		...
		try {
		 ...
		 @Test (priority = 10 ,dependsOnMethods="Tiff_File____Upload")
			...
			@Test (priority = 11 , dependsOnMethods="Tiff_File____Upload")
			...
			@Test (priority = 12 ,dependsOnMethods="Tiff_File____Upload")
			...
			@Test (priority = 13 ,dependsOnMethods="Tiff_File____Upload")
			...
			@Test (priority = 14 ,dependsOnMethods="Tiff_File____Upload")
			public void Free_Stamp___On_Tiff() throws InterruptedException  { 
			   try {
			...
			@Test (priority = 15 ,dependsOnMethods={"Tiff_File____Upload","Handel_Polygone___On_Tiff","Handle_StickyNote___On_Tiff"})
