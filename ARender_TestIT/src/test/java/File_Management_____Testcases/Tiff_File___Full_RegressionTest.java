...
public class Tiff_File___Full_RegressionTest  extends pageObject.TestBase implements ARender____FactoryPage, File____FactoryPage {
	 ...
	 */	 
		...
		try {
		    Assert.assertEquals(page.getInstance(HanlerBasePage.class).getNotificationMsg(notificationmsg),"Document courant : file_example_TIFF_10MB.tiff", "error accurred file can not uploaded");
	   ...
	   */
		...
		public void Handle_StickyNote___On_tiff (Method method) throws InterruptedException{ page.getInstance(StickyNoteAnnotationHandler.class).doDrowSticky();
	    // TODO Check notification message is not wrong
