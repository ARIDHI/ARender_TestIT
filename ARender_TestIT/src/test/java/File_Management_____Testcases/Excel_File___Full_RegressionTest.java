...
public class Excel_File___Full_RegressionTest  extends pageObject.TestBase implements ARender____FactoryPage, File____FactoryPage  {
	 ...
	 */	 
		...
		try {
		    Assert.assertEquals(page.getInstance(HanlerBasePage.class).getNotificationMsg(notificationmsg),"Document courant : TestARender.xlsx", "error accurred file can not uploaded");
		...
		/**
		   ...
		   * @throws InterruptedException
		   */
			@Test (priority = 2, alwaysRun= true , dependsOnMethods="Excel_File____Upload")
			 ...
			 * @throws InterruptedException
			 */
			@Test (priority = 3 , alwaysRun= true , dependsOnMethods="Excel_File____Upload")	
			 ...
			 * @throws InterruptedException
			 */
			@Test(priority = 4 , alwaysRun= true , dependsOnMethods="Excel_File____Upload")
			 ...
			 * @throws InterruptedException
			 */
			@Test (priority = 5 , alwaysRun= true , dependsOnMethods="Excel_File____Upload")
			 ...
			 * @throws InterruptedException
			 */
			@Test (priority = 6 , alwaysRun= true , dependsOnMethods="Excel_File____Upload")
			 ...
			 */
			 @Test (priority = 10 ,dependsOnMethods="Excel_File____Upload")
				 ...
				 * @throws InterruptedException
				 */
				@Test (priority = 15 ,dependsOnMethods={"Excel_File____Upload"})
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        @Test (priority = 23 ,timeOut = 10000)
