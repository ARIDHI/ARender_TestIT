 ...
 *
 */
public class Excel_File___Full_RegressionTest  extends pageObject.TestBase implements ARender____FactoryPage, File____FactoryPage  {
	/**
	 * 
	 * @param method
	 ...
	 */	 
		...
		try {
		    Assert.assertEquals(page.getInstance(HandlerBasePage.class).getNotificationMsg(notificationmsg),"Document courant : TestARender.xlsx", "error accurred file can not uploaded");
			...
			@Test (priority = 2 , dependsOnMethods="Excel_File____Upload")
			...
			@Test (priority = 3 , dependsOnMethods="Excel_File____Upload")	
			...
			@Test(priority = 4 , dependsOnMethods="Excel_File____Upload")
			...
			@Test (priority = 5 , dependsOnMethods="Excel_File____Upload")
			...
			@Test (priority = 6  , dependsOnMethods="Excel_File____Upload")
			...
			@Test (priority = 7 , dependsOnMethods="Excel_File____Upload")
			...
			@Test (priority = 8 , dependsOnMethods="Excel_File____Upload")
			public void Handle_polyline___On_Excel(Method method) throws InterruptedException { 
			try {
			...
			@Test (priority = 9 ,dependsOnMethods="Excel_File____Upload")
			public void Handel_Polygone___On_Excel(Method method) throws InterruptedException { 
			...
			try {
			 ...
			 @Test (priority = 10 ,dependsOnMethods="Excel_File____Upload")
				...
				@Test (priority = 11 , dependsOnMethods="Excel_File____Upload")
				...
				@Test (priority = 12 ,dependsOnMethods="Excel_File____Upload")
				...
				@Test (priority = 13 ,dependsOnMethods="Excel_File____Upload")
				...
				@Test (priority = 14 ,dependsOnMethods="Excel_File____Upload")
				public void Free_Stamp___On_Excel() throws InterruptedException  { 
				   try {
				...
				@Test (priority = 15 ,dependsOnMethods={"Excel_File____Upload","Handel_Polygone___On_Excel","Handle_StickyNote___On_Excel"})
