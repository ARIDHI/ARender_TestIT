...
public class JPEG_File___Full_RegressionTest extends pageObject.TestBase implements ARender____FactoryPage , File____FactoryPage {
	 ...
	 */	 
	   ...
	   * @throws InterruptedException
	   */
		@Test (priority = 2,  timeOut = 30000 , dependsOnMethods="Jpeg_File____Upload")
		public void Handle_StickyNote___OnJpeg (Method method) throws InterruptedException{ page.getInstance(StickyNoteAnnotationHandler.class).doDrowSticky();
	    // TODO Check notification message is not wrong
		 ...
		 * @throws InterruptedException
		 */
		@Test (priority = 3 ,timeOut = 30000 , dependsOnMethods="Jpeg_File____Upload")	
	    public void Handle_FreeText___OnJpeg (Method method) throws InterruptedException { page.getInstance(freeTextAnnotationHandler.class).doDrowfreetext(); 	
	    // TODO Check notification message is not wrong
	 	// TODO Check annotation is displayed 
	    // TODO Check style barre is displayed
	    try {
		 ...
		 * @throws InterruptedException
		 */
		@Test(priority = 4 ,timeOut = 30000 , dependsOnMethods="Jpeg_File____Upload")
		public void Handle_Circle___OnJpeg (Method method) throws InterruptedException { page.getInstance(circleAnnotationHandler.class).doDrowcircle();	
		// TODO Check notification message is not wrong
	    // TODO Check annotation is displayed 
	    // TODO Check style barre is displayed
		try {
		 ...
		 * @throws InterruptedException
		 */
		@Test (priority = 5 ,timeOut = 30000, dependsOnMethods="Jpeg_File____Upload")
		public void Handle_Arrow___OnJpeg(Method method) throws InterruptedException { page.getInstance(arrowAnnotationHandler.class).doDrowArrow();
		// TODO Check notification message is not wrong
	    // TODO Check annotation is displayed 
	    // TODO Check style barre is displayed
		try {
		 ...
		 * @throws InterruptedException
		 */
		@Test (priority = 6 ,timeOut = 30000 , dependsOnMethods="Jpeg_File____Upload")
		public void Handle_Underline___OnJpeg(Method method) throws InterruptedException {page.getInstance(UnderLineHandler.class).doDrowUnderline();
		// TODO Check notification message is not wrong
	    // TODO Check annotation is displayed 
	    // TODO Check style barre is displayed
		try {
		 ...
		 * @throws InterruptedException
		 */
		@Test (priority = 7 ,timeOut = 30000 , dependsOnMethods="Jpeg_File____Upload")
		public void Handle_freeHand___OnJpeg(Method method) throws InterruptedException { page.getInstance(freeHandAnnotationtHandler.class).doDrowfreehand();
		// TODO Check notification message is not wrong
	    // TODO Check annotation is displayed 
	    // TODO Check style barre is displayed
		try {
		 ...
		 * @throws InterruptedException
		 */
		@Test (priority = 8 ,timeOut = 30000 , dependsOnMethods="Jpeg_File____Upload")
		public void Handle_polyline___OnJpeg(Method method) throws InterruptedException { page.getInstance(polylineAnnotationHandler.class).doDrowpolyline();	
		// TODO Check notification message is not wrong
	    // TODO Check annotation is displayed 
	    // TODO Check style barre is displayed
		try {
		 ...
		 * @throws InterruptedException
		 */
		@Test (priority = 9 ,timeOut = 30000 , dependsOnMethods="Jpeg_File____Upload")
		public void Handel_Polygone___OnJpeg(Method method) throws InterruptedException { page.getInstance(PolygoneannotationHandler.class).doDrowpolygone();
		// TODO Check notification message is not wrong
	    // TODO Check annotation is displayed 
	    // TODO Check style barre is displayed
		try {
		 ...
		 * @throws InterruptedException
		 */
		 @Test (priority = 10 ,enabled= true,dependsOnMethods="Jpeg_File____Upload")
			 ...
			 * @throws InterruptedException
			 */
			@Test (priority = 11 ,enabled= true,dependsOnMethods="Jpeg_File____Upload")
			 ...
			 * @throws InterruptedException
			 */
			@Test (priority = 12 ,enabled= true,dependsOnMethods="Jpeg_File____Upload")
			 ...
			 * @throws InterruptedException
			 */
			@Test (priority = 13 ,enabled= true,dependsOnMethods="Jpeg_File____Upload")
			 ...
			 * @throws InterruptedException
			 */
			@Test (priority = 14 ,enabled= true,dependsOnMethods="Jpeg_File____Upload")
			 ...
			 * @throws InterruptedException
			 */
			@Test (priority =15 , alwaysRun = true ,dependsOnMethods="Jpeg_File____Upload")
		   ...
		   try {
			 ...
			 * @throws InterruptedException
			 */
			@Test (priority =16 , alwaysRun = true,dependsOnMethods="Jpeg_File____Upload" )
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        @Test (priority = 17 ,timeOut = 10000,dependsOnMethods="Jpeg_File____Upload")
       public void Download_PDF_File_via_eml (String url, Method method) throws InterruptedException{
        page.getInstance(DownloadPDF.class).DodownloadPdf();
       if(200 == RestAssured.post(url).statusCode()) { 
        Assert.assertTrue(true);    
          }
       else if(500 == RestAssured.post(url).statusCode()) {
    	   System.out.println("[ERROR] 500 : BAD REQUEST " + "FILE CAN NOT BE DOWnLOADED");
       }
        else {
        	System.out.println("[ERROR] Pending : BAD REQUEST " + "FILE CAN NOT BE DOWnLOADED");
        }
        Thread.sleep(1000);
        }	

        @Test (priority = 18  ,timeOut = 10000,dependsOnMethods="Jpeg_File____Upload")
        public void DownloadAnnotation_FDF_File_via_eml(String url,Method method) throws InterruptedException{
	     page.getInstance(circleAnnotationHandler.class).doDrowcircle();
       ...
       @Test (priority = 19 ,timeOut = 10000,dependsOnMethods="Jpeg_File____Upload")
       public void DownloadAnnotation_XFDF_File_via_eml(String url,Method method) throws InterruptedException{ page.getInstance(DownloadAnnotation_XFDF.class).Dodownloadxfdf();
       if(200 == RestAssured.post(url).statusCode()) { 
           Assert.assertTrue(true);    
             }
          else if(500 == RestAssured.post(url).statusCode()) {
       ...
       @Test (priority = 20  ,timeOut = 10000,dependsOnMethods="Jpeg_File____Upload")
       public void Download_Document_withAnnotation_FDF_File_via_eml(String url,Method method) throws InterruptedException{ page.getInstance(DownloadDocumentwithAnnotationFDF.class).DodownloadwithAnnotationFdf();
       if(200 == RestAssured.post(url).statusCode()) { 
           Assert.assertTrue(true);    
             }
          else if(500 == RestAssured.post(url).statusCode()) {
       ...
       @Test (priority = 21 ,timeOut = 10000,dependsOnMethods="Jpeg_File____Upload")
       public void DownLoad_With_Annotation_CSV_File_via_eml(String url,Method method) throws InterruptedException{ page.getInstance(DownLoadWithAnnotationCSV.class).DodownloadWithAnnotationCSV();
       if(200 == RestAssured.post(url).statusCode()) { 
           Assert.assertTrue(true);    
             }
          else if(500 == RestAssured.post(url).statusCode()) {
       ...
       @Test(priority = 22,dependsOnMethods="Jpeg_File____Upload" )
       public void Upload__File_via_eml(String url,Method method) throws InterruptedException  {
