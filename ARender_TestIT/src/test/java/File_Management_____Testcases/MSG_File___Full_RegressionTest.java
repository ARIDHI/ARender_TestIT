 ...
 *
 */
public class MSG_File___Full_RegressionTest  extends pageObject.TestBase implements ARender____FactoryPage, File____FactoryPage {
	/**
	 * 
	 * @param method
	 ...
	 */	 
		...
		try {
		    Assert.assertEquals(page.getInstance(HandlerBasePage.class).getNotificationMsg(notificationmsg),"Document courant : Email:(outlookEMLandMSGconverter Trial Version Import) BitDaddys Software", "error accurred file can not uploaded");
		...
		@Test (priority = 2 , dependsOnMethods="MSG_File____Upload")
		public void Handle_StickyNote___On_MSG (Method method) throws InterruptedException{ 
		...
		@Test (priority = 3 , dependsOnMethods="MSG_File____Upload")	
	    public void Handle_FreeText___On_MSG (Method method) throws InterruptedException { 
    	 try {
		...
		@Test(priority = 4 , dependsOnMethods="MSG_File____Upload")
		...
		@Test (priority = 5 , dependsOnMethods="MSG_File____Upload")
		public void Handle_Arrow___On_MSG(Method method) throws InterruptedException {
			try {
		...
		@Test (priority = 6  , dependsOnMethods="MSG_File____Upload")
		public void Handle_Underline___On_MSG(Method method) throws InterruptedException {
		  try {
		...
		@Test (priority = 7 , dependsOnMethods="MSG_File____Upload")
		public void Handle_freeHand___On_MSG(Method method) throws InterruptedException { 
		   try {
			 page.getInstance(freeTextAnnotationHandler.class).checkFreeTextTest();
		     }			
	       finally { 
		...
		@Test (priority = 8 , dependsOnMethods="MSG_File____Upload")
		public void Handle_polyline___On_MSG(Method method) throws InterruptedException { 
		try {
		...
		@Test (priority = 9 ,dependsOnMethods="MSG_File____Upload")
		public void Handel_Polygone___On_MSG(Method method) throws InterruptedException { 
		...
		try {
		 ...
		 @Test (priority = 10 ,dependsOnMethods="MSG_File____Upload")
			...
			@Test (priority = 11 , dependsOnMethods="MSG_File____Upload")
			...
			@Test (priority = 12 ,dependsOnMethods="MSG_File____Upload")
			...
			@Test (priority = 13 ,dependsOnMethods="MSG_File____Upload")
			...
			@Test (priority = 14 ,dependsOnMethods="MSG_File____Upload")
			public void Free_Stamp___On_MSG() throws InterruptedException  { 
			   try {
			...
			@Test (priority = 15 ,dependsOnMethods={"MSG_File____Upload","Handel_Polygone___On_MSG","Handle_StickyNote___On_MSG"})
