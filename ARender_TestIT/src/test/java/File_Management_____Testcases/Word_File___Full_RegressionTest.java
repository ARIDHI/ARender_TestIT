 ...
 *
 */
public class Word_File___Full_RegressionTest extends pageObject.TestBase implements ARender____FactoryPage , File____FactoryPage {
	/**
	 * 
	 * @param method
	 ...
	 */	 
		...
		try {
		    Assert.assertEquals(page.getInstance(HanlerBasePage.class).getNotificationMsg(notificationmsg),"Document courant : Bonnes_pratiques.docx", "error accurred file can not uploaded");
	   ...
	   */
		...
		public void Handle_StickyNote___On_Word (Method method) throws InterruptedException{ page.getInstance(StickyNoteAnnotationHandler.class).doDrowSticky();
	    // TODO Check notification message is not wrong
