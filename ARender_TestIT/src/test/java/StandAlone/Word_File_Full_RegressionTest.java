 ...
 *
 */
public class Word_File_Full_RegressionTest extends pageObject.TestBase implements FactoryLocator , FileFactoryLocator {

	@Test(priority = 1 , alwaysRun = true ,enabled= true)
	 public void Upload_word_File (Method method) throws InterruptedException, IOException {
	...
	@Test (priority = 2 , dependsOnMethods="Upload_word_File")
	 	public void Handle_StickyNote_On_word(Method method) throws InterruptedException{ 
		...
		@Test (priority = 3 , dependsOnMethods="Upload_word_File")	
	    public void Handle_FreeText_On_word(Method method) throws InterruptedException { 
  	 try {
		...
		@Test(priority = 4 , dependsOnMethods="Upload_word_File")
		...
		@Test (priority = 5 , dependsOnMethods="Upload_word_File")
		public void Handle_Arrow_On_word(Method method) throws InterruptedException {
			try {
		...
		@Test (priority = 6  , dependsOnMethods="Upload_word_File")
		public void Handle_Underline_On_word(Method method) throws InterruptedException {
		  try {
		...
		@Test (priority = 7 , dependsOnMethods="Upload_word_File")
		public void Handle_freeHand_On_word(Method method) throws InterruptedException { 
		   try {
		...
		@Test (priority = 8 , dependsOnMethods="Upload_word_File")
		public void Handle_polyline_On_word(Method method) throws InterruptedException { 
		try {
		...
		@Test (priority = 9 ,dependsOnMethods="Upload_word_File")
		public void Handel_Polygone_On_word(Method method) throws InterruptedException { 
		...
		try {
		 ...
		 @Test (priority = 10 ,dependsOnMethods="Upload_word_File")
			public void Urgent_Stamp_On_word() throws InterruptedException { 
			try {
			...
			@Test (priority = 11 , dependsOnMethods="Upload_word_File")
			public void Approved_Stamp_On_word() throws InterruptedException  { 
			try {
			...
			@Test (priority = 12 ,dependsOnMethods="Upload_word_File")
			public void Draft_Stamp_On_word() throws InterruptedException  { 
			 try {
			...
			@Test (priority = 13 ,dependsOnMethods="Upload_word_File")
			public void Signature_Stamp_On_word() throws InterruptedException  { 
		     try {
			...
			@Test (priority = 14 ,dependsOnMethods="Upload_word_File")
			public void Free_Stamp_On_word() throws InterruptedException  { 
		 ...
		 int actualStackPanelSize = page.findElements(stackPanel_content).size();
			...
			@Test (priority = 19 ,dependsOnMethods="Upload_word_File")
			public void Add_a_Signet_On_word(Method method) throws InterruptedException, IOException {				
				page.getInstance(signetFonction.class).addAncre();		   
				 try {
				  ...
				  try {
					  Assert.assertEquals(page.getInstance(signetFonction.class).treeItemSize(), 6);
					  }catch(Exception i) {
				      }
		          }
		
			@Test (priority = 20 ,dependsOnMethods="Add_a_Signet_On_word")
			public void Delete_a_Signet_On_word(Method method) throws InterruptedException, IOException {
		        ...
		        try {
					  Assert.assertEquals(page.getInstance(signetFonction.class).treeItemSize(), 3);
					  }catch(Exception i) {
				      }
			...
			@Test (priority = 21 ,dependsOnMethods="Upload_word_File")
			public void ADD_AN_ANCRE_On_word(Method method) throws InterruptedException, IOException {
				
				AncreTest ancre = new AncreTest();
				ancre.Copy_Ancre(method);
			}
			
			@Test (priority = 22 ,dependsOnMethods="Upload_word_File")
			public void SKIP_AN_ANCRE_On_word(Method method) throws InterruptedException, IOException {
				
				AncreTest ancre = new AncreTest();
				ancre.Skip_Ancre(method);
			}
			
			@Test (priority = 23 ,dependsOnMethods="Upload_word_File")
			public void ZoomIn_On_word(Method method) throws InterruptedException, IOException {
				
				ZoomTest zoom = new ZoomTest();
				zoom.zoomIn(method);
			}
			
			@Test (priority = 24 ,dependsOnMethods="Upload_word_File")
			public void ZoomOut_On_word(Method method) throws InterruptedException, IOException {
				
				ZoomTest zoom = new ZoomTest();
				zoom.zoomOut(method);
			}
			
			@Test (priority = 25 ,dependsOnMethods="Upload_word_File")
			public void ZoomInZone_On_word(Method method) throws InterruptedException, IOException {
				
				ZoomTest zoom = new ZoomTest();
				zoom.zoomIn_Zone(method);
			}
			
			@Test (priority = 26 ,dependsOnMethods="Upload_word_File")
			public void Zoom_Adjust_On_word(Method method) throws InterruptedException, IOException {
				
				ZoomTest zoom = new ZoomTest();
				zoom.zoomAdjust(method);
			}
			
			@Test (priority = 27 ,dependsOnMethods="Upload_word_File")
			public void Zoom_Text_Box_Control_On_word(Method method) throws InterruptedException, IOException {
				
				ZoomTest zoom = new ZoomTest();
				zoom.zoomTextBox(method);
			}
			
			@Test (priority = 28 ,dependsOnMethods="Upload_word_File")
			public void Left_Rotation_Control_On_word(Method method) throws InterruptedException, IOException {
				
				RotationTest rotation = new RotationTest();
				rotation.leftRotation(method);
			}
			
			@Test (priority = 29 ,dependsOnMethods="Upload_word_File")
			public void Right_Rotation_Control_On_word(Method method) throws InterruptedException, IOException {
				
				RotationTest rotation = new RotationTest();
				rotation.rightRotation(method);
			}
			
			@Test (priority = 30 ,dependsOnMethods="Upload_word_File")
			public void Activate_Multiview_On_word(Method method) throws InterruptedException, IOException {
				
				MultiviewTest multiview = new MultiviewTest();
				multiview.Activate_Multiview(method);
			}
			
			@Test (priority = 31 ,dependsOnMethods="Activate_Multiview_On_word")
			public void Desactivate_Multiview_On_word(Method method) throws InterruptedException, IOException {
				
				MultiviewTest multiview = new MultiviewTest();
				multiview.Desactivate_Multiview(method);
			}
			
			@Test (priority = 32 ,dependsOnMethods="Upload_word_File")
			public void Multi_Multiview_On_word(Method method) throws InterruptedException, IOException {
